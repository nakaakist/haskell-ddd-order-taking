...
module OrderTaking.Types.AddressSpec (spec) where
...
spec = do
  describe "Address" $ do
    ...
    it "should fail to create 1234" $ do
      ...
      Address.create params `shouldBe` Left "zip code 1234 is invalid. must be 5 digits number"

-- helper functions

createParamsWithZipCode :: Text -> Address.Params
createParamsWithZipCode c =
  Address.Params
    { Address.addressLine1 = validAddressLine,
      Address.addressLine2 = validAddressLine,
      Address.addressLine3 = validAddressLine,
